...
| Image                       | Purpose             | Type            | Reason                                 |
| --------------------------- | ------------------- | --------------- | -------------------------------------- |
| logo.png                    | Brand identity      | Real            | Primary portfolio branding             |
| mr-khaled-morcy.jpg         | Hero/About          | Real Photo      | Represents me authentically            |
| darsy.jpg                   | Featured Project    | Real Screenshot | Demonstrates LMS interface             |
| home-champion.jpg           | Featured Project    | Real Screenshot | Shows dashboard and responsive design  |
| tomory-ecommerce.jpg        | Featured Project    | Real Screenshot | Demonstrates ecommerce experience      |
| hospital-api.png            | Backend Project     | Real Screenshot | Represents REST API implementation     |
...
No AI-generated images were used to represent portfolio projects.

If AI assets are used in the final portfolio, they will be limited to:
...
These elements support the design without replacing evidence of real work.
